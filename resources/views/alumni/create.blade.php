  ...
  <body>
    ...
    <div class="container-fluid bg-light">
        <div class="container" style="background-color: #fffafc;">
            ...
            <!-- validation -->
            <!-- end validation -->
            <form class="form-horizontal" enctype="multipart/form-data" role="form" action="/alumni" method="post">
            @csrf
              <div class="container">
            ...
            <div class="row justify-content-center mb-3">
              <div class="col-md-5">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="domisili_pekerjaan" placeholder="Masukkan Domisili Pekerjaan">
                </div>
              </div>
            </div>
            <div class="row justify-content-center mb-3">
              <div class="col-md-5">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="domisili_asal" placeholder="Masukkan Domisili Asal">
                </div>
              </div>
            </div>
            <div class="row justify-content-center mb-3">
              <div class="col-md-5">
                <label for="basic-url" class="form-label">Instagram</label>
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-url" name="instagram" aria-describedby="basic-addon3"  placeholder="Masukkan Link Instagram">
                  </div>
              </div>
            </div>
            <div class="row justify-content-center mb-3">
              <div class="col-md-5">
                <label for="basic-url" class="form-label">Linkedin</label>
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-url" name="linkedin" aria-describedby="basic-addon3" placeholder="Masukkan Link Linkedin">
                  </div>
              </div>
            </div>
            <div class="row justify-content-center mb-3">
              <div class="col-md-5">
                <label for="basic-url" class="form-label">Github</label>
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-url" name="github" aria-describedby="basic-addon3" placeholder="Masukkan Link Github">
                  </div>
              </div>
            </div>
            <div class="row justify-content-center mb-3">
